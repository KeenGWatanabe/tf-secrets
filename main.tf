...
resource "aws_secretsmanager_secret_version" "mongo_uri" {
  ...
  secret_string = jsonencode({
    mongodb_uri = "mongodb+srv://${var.mongodb_username}:${var.mongodb_password}@${var.mongodb_host}/?retryWrites=true&w=majority&appName=tasks" # :27017/mydb?authSource=admin"
  })
}
